"""Region redactor for detected text boxes."""
...
class TextRedactor(BaseAnonymiser):
    """Redact detected text regions using blur or solid fill."""

    method_name = "text_redactor"

    def __init__(self, mode: str = "blur", blur_radius: float = 12.0, fill_color: tuple[int, int, int] = (0, 0, 0)) -> None:
