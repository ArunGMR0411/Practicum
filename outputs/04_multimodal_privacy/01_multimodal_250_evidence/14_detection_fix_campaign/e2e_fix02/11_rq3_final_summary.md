...
- Adaptive privacy score: `0.8546`.
- Adaptive utility score: `0.6689`.
- Adaptive multimodal anonymisation score: `0.8273`.
- Strongest fixed policy: `fixed_text_blur_screen_fill` with score `0.8271`.
- Adaptive minus strongest fixed: `0.0001`.

## Adaptive policy (development-selected)

- `no_text_screen_risk` → `no_action_copy` (No predicted text/screen boxes; preserve the image.)
- `screen_present` → `text_fill_screen_fill` (Highest development-split measured score; privacy breaks score ties.)
- `text_and_screen_present` → `text_blur_screen_fill` (Highest development-split measured score; privacy breaks score ties.)
- `text_present` → `text_blur_screen_blur` (Highest development-split measured score; privacy breaks score ties.)
...
- Missed screen-risk images: `1`.
- Text readability below the privacy threshold: `6` flagged images.
- Screen obscuration below the privacy threshold: `2` flagged images.
