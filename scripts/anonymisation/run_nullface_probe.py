...
"""Run the smallest real CASTLE probe for the NullFace adapter."""
...
RUNNER = PROJECT_ROOT / "scripts" / "run_nullface.py"
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "outputs" / "nullface_probe"
...
def main() -> None:
    ...
    output_path = output_dir / "nullface_output.webp"
    ...
    summary = {
        ...
        "notes": [
            "Minimum real CASTLE smoke for NullFace adapter wiring.",
            "This validates crop-mask construction, backend invocation, and write path before broader comparison work.",
        ],
    }
