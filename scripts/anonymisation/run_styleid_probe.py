...
"""Run the smallest real CASTLE probe for the StyleID adapter."""
...
RUNNER = PROJECT_ROOT / "scripts" / "run_stylegan.py"
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "outputs" / "runs" / "styleid_probe"
...
def main() -> None:
    ...
    output_path = output_dir / "styleid_output.webp"
    ...
    summary = {
        ...
        "notes": [
            "Minimum real CASTLE smoke for StyleID adapter wiring.",
            "Uses one reviewed face box to avoid spending wall time on quality evaluation.",
            "Success here validates command, asset, adapter, and image write path before constrained-compute.",
        ],
    }
