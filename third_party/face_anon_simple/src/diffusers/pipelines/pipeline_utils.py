...
if is_transformers_available():
    ...
    TRANSFORMERS_FLAX_WEIGHTS_NAME = getattr(transformers.utils, "FLAX_WEIGHTS_NAME", "flax_model.msgpack")
...
class DiffusionPipeline(ConfigMixin, PushToHubMixin):
    ...
    def register_modules(self, **kwargs):
        ...
        package_root = __name__.split(".pipelines", 1)[0]
        diffusers_module = importlib.import_module(package_root)
